...
function AddService () {
    ...
    const submitService = (e) => {
        ...
        formData.append('authEmail', serviceInput.authEmail);
        ...
        axios.post('/api/store-service', formData).then(res=> {
        ...
        <div className="container-fluid px-4">
            <div className="mt-5 card mt-4">
                ...
                <div className="card-body">
                    <form onSubmit={submitService} encType="multipart/form-data">

                        <div className="row">
                        <div className="form-group mb-3">
                                <input type="hidden" name="authEmail" onChange={handleInput} value={serviceInput.authEmail} className="form-control" />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="row">
                                ...
                                {/* discount eka danmama selling price eka change wenna hadanna */}
                                <div className="col-md-4">
                                <div className="form-group mb-3">
