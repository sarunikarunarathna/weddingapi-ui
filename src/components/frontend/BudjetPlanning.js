...
{    
         ...
         const searchItem = (e, budget_item) => {
             axios.get(`/api/search-item/${budget_item}`).then(res=>{
                 if(res.data.status === 200) 
                 {
                     console.log(res.data.item)
                     setSearchItem(res.data.budget);
                 }
             });
         }
     
         var showItemList = '';
         showItemList = searchItemList.map( (item, idx) => {
             return (
                <div>
        ...
        <div>
            ...
            <div className="row">
                ...
                <div className="row bg-secondary ">
                    ...
                    <div className="col-md-2 py-3">
                    <Link to={'paid-items'} className="btn btn-outline-dark"><i className="fas fa-search"></i> Fully Paid Items</Link>
                    </div>
